...
function GroupPost({
  ...
  const shareUrl = "https://frendzit-a0ec6.web.app/grp/" + postId;
  ...
  const deletePost = () => {
    db.collection("group_posts").doc(postId).delete();
    setOpen(false);
  };
  return (
    <>
      ...
      <div className="post">
        <div className="post__top">
          <div className="post__topLeft">
            <Link to={"/group/" + group} className="profile__link">
        ...
        <div className="post__options">
          ...
          <Link to={"/grp/" + postId} className="postComment__link">
